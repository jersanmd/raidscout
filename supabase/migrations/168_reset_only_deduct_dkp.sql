-- 168: reset_all_dkp — only zero out balances, do not touch auctions or bids
...
BEGIN
  ...
  -- NOTE: Active auctions, bids, and item bid flags are intentionally NOT touched.
  -- The reset only zeroes out DKP balances via adjustment transactions.
END;
$$;
