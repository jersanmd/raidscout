-- 115: Add auction_round to dkp_bids and items for tracking bid cycles
...
-- Update mark_item_for_bid to increment the round each time an item is marked
...
-- Update place_bid to stamp the current auction_round from the item
...
BEGIN
  ...
  -- Validate item
  SELECT id, is_up_for_bid, dkp_min_bid, bid_end_time, server_id, auction_round
