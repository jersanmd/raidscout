-- 006_auto_assign_guild.sql
-- When a server has exactly 1 guild, auto-assign all bosses & activities
-- to that guild with rotation (per-kill) mode.

-- Update create_server_with_bosses to auto-assign single guild
