-- 021_set_game_slug_on_server_create: Update create_server_with_bosses RPC
-- to also populate the game (slug) column on servers, not just game_id.
-- Also adds p_guild_name parameter for automatic guild creation.
