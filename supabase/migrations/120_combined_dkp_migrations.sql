-- 120: Combined DKP migrations (115-119) for staging deployment
-- auction_round columns, updated RPCs, notifications, rankings fix

-- ── 115: auction_round ──
ALTER TABLE public.dkp_bids ADD COLUMN IF NOT EXISTS auction_round INTEGER NOT NULL DEFAULT 1;
ALTER TABLE public.items ADD COLUMN IF NOT EXISTS auction_round INTEGER NOT NULL DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_dkp_bids_item_round ON dkp_bids(item_id, auction_round);

-- ── 116: delete_auction_round ──
...
-- ── 118: DKP notifications ──
-- Update mark_item_for_bid to increment auction_round
...
-- Update place_bid with auction_round + notifications
...
-- Update auto_resolve_auction with notifications
...
-- ── 119: rankings show all members + guild ──
