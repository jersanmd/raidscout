-- 183: Restore bid notifications in place_bid (overwritten by migration 175)
-- Migration 175 redeployed place_bid without notification inserts,
-- breaking outbid notifications and realtime banners.
