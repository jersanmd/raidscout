-- Migration: Apply point_rules time multipliers to activity scores in get_leaderboard
-- Also adds activity_guilds.points override support (like boss_guilds.points for bosses)
