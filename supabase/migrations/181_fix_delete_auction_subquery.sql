-- 181: Fix delete_auction_round — use ANY(arr) pattern instead of subquery
-- The subquery-based version fails when dkp_bids has RLS enabled.
-- Restores the old ANY(v_bid_ids) pattern and also adds dkp_auctions cleanup.
