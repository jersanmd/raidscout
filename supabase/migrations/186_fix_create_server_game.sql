-- 186: Fix create_server_with_bosses — restore game column in INSERT (removed by migration 172)
-- Without game set, Mark Item for Bid modal can't find catalog items.
...
-- Also backfill game for the 2 servers created with the buggy version
