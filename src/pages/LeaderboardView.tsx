...
export function LeaderboardView() {
  ...
  if (isLoading || guildsLoading) {
    return (
    <div className="max-w-[95%] 2xl:max-w-[1600px] mx-auto px-3 sm:px-4 py-4 sm:py-6">
  ...
  return (
    <div className="max-w-[95%] 2xl:max-w-[1600px] mx-auto px-3 sm:px-4 py-4 sm:py-6 space-y-2 sm:space-y-3">
      {/* Header */}
