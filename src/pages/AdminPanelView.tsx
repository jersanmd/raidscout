  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex flex-col">
      ...
      <div className="w-full border-b border-[#27272a] bg-[#09090b]/70 backdrop-blur-xl">
        <div className="max-w-[95%] 2xl:max-w-[1600px] mx-auto px-4 h-14 flex items-center">
      ...
      <div className="w-full max-w-[95%] 2xl:max-w-[1600px] mx-auto px-3 sm:px-4 py-4 sm:py-6 space-y-4 sm:space-y-6 flex-1 overflow-x-hidden min-w-0 pb-16 md:pb-0">
