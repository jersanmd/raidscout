...
export const AuditAction = {
  ...
  COLLECTION_OWNERSHIP_SET: "collection_ownership_set",
  COLLECTION_OWNERSHIP_REMOVE: "collection_ownership_remove",
...
export const AUDIT_ACTION_GROUPS: { label: string; actions: AuditActionType[] }[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      AuditAction.BOSS_ROTATION_ADVANCE,
      AuditAction.BOSS_GUILDS_SET,
      AuditAction.BOSS_SPAWN_SET,
  ...
  },
  {
    ...
    actions: [
      ...
      AuditAction.ACTIVITY_TIME_EDIT,
      AuditAction.ACTIVITY_FINALIZE,
      AuditAction.ACTIVITY_END_RECORD,
  ...
  },
  {
    ...
    actions: [
      ...
      AuditAction.MEMBER_ACTIVE_TOGGLE,
  ...
  },
  {
    ...
    actions: [
      ...
      AuditAction.PARTY_ASSIGN,
      AuditAction.PARTY_UNLINK,
      AuditAction.PARTY_MEMBER_ADD,
      AuditAction.PARTY_MEMBER_REMOVE,
  ...
  },
  {
    ...
    actions: [
      ...
      AuditAction.COLLECTION_ITEM_ADD,
      AuditAction.COLLECTION_ITEM_REMOVE,
      AuditAction.COLLECTION_OWNERSHIP_SET,
      AuditAction.COLLECTION_OWNERSHIP_REMOVE,
    ],
  },
  {
    label: "Leaderboard",
    actions: [
      AuditAction.LEADERBOARD_FINALIZE,
      AuditAction.LEADERBOARD_RESET,
      AuditAction.LEADERBOARD_ADJUST_POINTS,
      AuditAction.LEADERBOARD_RESET_GUILD,
    ],
  },
  {
    label: "Guilds",
  ...
  },
  {
    ...
    actions: [
      ...
      AuditAction.RALLY_IMAGE_ADD,
      AuditAction.RALLY_SCAN_SAVE,
      AuditAction.POINT_RULE_CREATE,
      AuditAction.POINT_RULE_UPDATE,
      AuditAction.POINT_RULE_DELETE,
    ],
  },
  {
    label: "Subscription",
...
export async function writeAuditEntry(entry: {
  ...
  if (error) {
    console.warn("[audit] write failed:", error.message, error.code);
    throw error;
  }
}
