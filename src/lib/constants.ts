...
export const BOSSES: Omit<Boss, "id" | "created_at">[] = [
  ...
  { name: "Chaiflock", spawn_type: "fixed_schedule", respawn_hours: null, schedule: [{ day: 6, time: "15:00" }] },
  ...
  { name: "Thymele · Mon", spawn_type: "fixed_schedule", respawn_hours: null, schedule: [{ day: 1, time: "19:00" }] },
  { name: "Thymele · Wed", spawn_type: "fixed_schedule", respawn_hours: null, schedule: [{ day: 3, time: "11:30" }] },
